...
HD_PWD='C:/Users/samum/Comp541/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vgadisplaydriver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vgadisplaydriver.tcl -notrace
