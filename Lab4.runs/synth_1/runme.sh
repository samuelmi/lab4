...
HD_PWD='C:/Users/samum/Comp541/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vgadisplaydriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vgadisplaydriver.tcl
